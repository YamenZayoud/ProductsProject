...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Profile</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
						</div>
					</div>
									...
									<div class="main-profile-overview">
										...
										<div class="d-flex justify-content-between mg-b-20">
											<div>
												...
												<p class="main-profile-name-text badge badge-light" >{{auth()->user()->type}}</p>
											</div>
										</div>
										<!--<h6>Bio</h6>
										...
										<div class="row">
											<div class="col-md-4 col mb20">
												...
												@php
													$user = auth()->user();
													$NumOfOrders = count($user->orders);
												@endphp

												<h5>{{$NumOfOrders}}</h5>
												<h6 class="text-small text-muted mb-0">Orders</h6>
											</div>
											<div class="col-md-4 col mb20">
												<h5>-</h5>
										...
										<div class="card-body">
											<div class="counter-status d-flex md-mb-0">
												...
												<div class="mr-auto">
													...
													<h5 class="tx-13">All Orders</h5>
													
													<h2 class="mb-0 tx-22 mb-1 mt-1">{{$AllOreders}}</h2>
									...
									<div class="card ">
										<div class="card-body">
											<div class="counter-status d-flex md-mb-0">
												...
												<div class="mr-auto">
													<h5 class="tx-13">Gross Sales</h5>
													<h2 class="mb-0 tx-22 mb-1 mt-1">{{$GrossSales}}$</h2>
													<p class="text-muted mb-0 tx-11"><i class="si si-arrow-up-circle text-success mr-1"></i>increase</p>
												</div>
											</div>
										</div>
									...
									<div class="card ">
										<div class="card-body">
											<div class="counter-status d-flex md-mb-0">
												...
												<div class="mr-auto">
													<h5 class="tx-13">Sold products</h5>
													
													<h2 class="mb-0 tx-22 mb-1 mt-1">{{$TotalQuantity}}</h2>
													<p class="text-muted mb-0 tx-11"><i class="si si-arrow-up-circle text-success mr-1"></i>increase</p>
												</div>
											</div>
										</div>
