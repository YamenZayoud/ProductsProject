				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							...
							<a href="{{route('products.index')}}"><h5 class="content-title mb-0 my-auto">Products</h5></a><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{$chosenProduct->name}}</span>
						</div>
					</div>
							...
							<div class="card-body h-100">
								<div class="row row-sm ">
									...
									<div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
										...
										<h5 class="product-title mb-1 text-warning">{{$chosenProduct->category->name}}</h5><br><br>

										<h4 class="product-title mb-1">{{$chosenProduct->name}}</h4><br><br>
										...
										<h6 class="price">current price: <span class="h3 ml-2">{{$chosenProduct->price}}</span></h6>
										<p class="product-description">{{$chosenProduct->discription}}</p>
										...
										<form action="{{ route('test1', ['product_id' => $chosenProduct->id ]) }}" method="post">
											@csrf
											@method('post')
