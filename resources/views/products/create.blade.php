...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Add a Product</h4>
						</div>
					</div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="mg-b-20">Use this form to fill in the product information.</p>
                                        <div id="wizard3">
                                            ...
                                            <section>
                                                ...
                                                <div class="control-group form-group">
                                                    ...
                                                    <input type="float" class="form-control" name="price" placeholder="Enter Price">
                                                </div>
                                            </section>
                                            ...
                                            <section>
                                                <div class="form-group has-success mg-b-0">
                                                    ...
                                                    <textarea class="form-control mg-t-20" type="text" name="discription" placeholder="Textarea (success state)" required="" rows="3">This is textarea</textarea>
                                                </div><br>
