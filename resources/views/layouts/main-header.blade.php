					...
					<div class="main-header-left ">
						...
						<div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
							<form action="{{ route('search') }}" method="GET">
								<input name="Search" class="form-control" placeholder="Search for a Product..." type="search">
								<button type="submit" class="btn"><i class="fas fa-search d-none d-md-block"></i></button>
							</form>
						</div>
